...
module.exports = [
  ...
  // ---------- Angular 包 ----------
  {
    name: 'angular: index.mjs (main entry, gzip)',
    path: 'packages/angular-file-preview/lib/index.mjs',
    limit: '3 MB',
    gzip: true,
  },
  {
    name: 'angular: all js (entry + chunks, gzip)',
    path: [
      'packages/angular-file-preview/lib/index.mjs',
      'packages/angular-file-preview/lib/chunks/*.mjs',
    ],
    limit: '3 MB',
    gzip: true,
  },
  {
    name: 'angular: css (gzip)',
    path: 'packages/angular-file-preview/lib/**/*.css',
    limit: '3 MB',
    gzip: true,
  },
];
