# renderer-toolbar-events Specification

## Purpose

Defines the event-driven subscription mechanism between renderers and the main preview component for toolbar state synchronization, replacing the legacy polling approach while maintaining backward compatibility.
