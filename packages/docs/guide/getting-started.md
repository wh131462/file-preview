...
File Preview 是一个现代化的文件预览组件，提供功能完全对等的 **React**、**Vue 3** 和 **Angular** 三个版本。
...
- <img src="/assets/icons/lightning.svg" width="20" height="20" style="display:inline;vertical-align:middle" /> **多框架** - React 18+、Vue 3 与 Angular 19 完整对等版本
